...
delete :: Ord a => a -> SetRBT a -> SetRBT a
delete = RBT.delete
...
--- second set.
union :: Ord a => SetRBT a -> SetRBT a -> SetRBT a
...
intersection :: Ord a => SetRBT a -> SetRBT a -> SetRBT a
