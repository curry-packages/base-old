...
withPreContract1 :: String -> (a -> Bool) -> (a -> b) -> a -> b
withPreContract1 fname precond fun arg
  | checkPre fname (precond arg) (showATerm arg)
  = fun arg

withPreContract2 :: String -> (a -> b -> Bool)
                 -> (a -> b -> c) -> a -> b -> c
...
withPostContract1ND :: String -> (a -> b -> Values Bool) -> (b -> b)
                    -> (a -> b) -> a -> b
...
withPostContract2 :: String -> (a -> b -> c -> Bool) -> (c -> c)
                  -> (a -> b -> c) -> a -> b -> c
...
withPostContract2ND :: String -> (a -> b -> c -> Values Bool) -> (c -> c)
                    -> (a -> b -> c) -> a -> b -> c
