...
import Pretty hiding        ( list, listSpaced, tupled, tupledSpaced, set
                            , setSpaced )
import AbstractCurry2.Select hiding (varsOfLDecl, varsOfFDecl, varsOfStat)
import AbstractCurry2.Types
import AbstractCurry2.Transform (typesOfCurryProg, funcsOfCurryProg)
import Function                (on)
